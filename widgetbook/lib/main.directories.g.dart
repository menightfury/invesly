...
import 'package:widgetbook_workspace/color_picker_wb.dart'
          ...
          _widgetbook.WidgetbookFolder(
            ...
            children: [
              _widgetbook.WidgetbookComponent(
                name: 'InveslyColorPickerWidget',
                useCases: [
                  _widgetbook.WidgetbookUseCase(
                    name: 'Default',
                    builder: _widgetbook_workspace_color_picker_wb
                        .buildColorPickerUseCase,
                  ),
                ],
              ),
              _widgetbook.WidgetbookComponent(
