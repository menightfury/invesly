...
//           SliverToBoxAdapter(
//             child: Padding(
//               padding: EdgeInsetsDirectional.symmetric(horizontal: getHorizontalPaddingConstrained(context)),
...
//                             ? null
//                             : Theme.of(context).colorScheme.tertiaryContainer,
//                         iconColor: searchFilters.isClear(ignoreDateTimeRange: true, ignoreSearchQuery: true)
//                             ? null
//                             : Theme.of(context).colorScheme.onTertiaryContainer,
//                         onTap: () {
...
//         ],
//         selectedTransactionsAppBar: SelectedTransactionsAppBar(pageID: "TransactionsSearch"),
//       ),
//     );
//   }
// }
...
//               icon == null
//                   ? SizedBox.shrink()
//                   : Padding(padding: const EdgeInsetsDirectional.only(end: 5), child: Icon(icon, size: 23)),
