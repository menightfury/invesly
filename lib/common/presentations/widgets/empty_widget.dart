...
class EmptyWidget extends StatelessWidget {
  const EmptyWidget({super.key, this.height = 128.0, this.label, this.onPressed});
...
//   <path d="M24 6C24 4.89543 24.8954 4 26 4H69V12.9024C69 15.1116 70.7909 16.9024 73 16.9024H81C82.1046 16.9024 83 17.7979 83 18.9024V78C83 79.1046 82.1046 80 81 80H26C24.8954 80 24 79.1046 24 78V6Z" fill="#FF8D8D"/>
